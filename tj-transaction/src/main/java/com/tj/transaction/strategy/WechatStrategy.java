...
///**
// * @program: tj-core
// * @description: 微信交易策略组件
// * @author: liang.song
// * @create: 2018-11-28-11:50
// **/
//@Component
//public class WechatStrategy extends AbstractTransactionStrategy {
//
...
//    @Value("${transaction.wechat-charge-url}")
//    private String chargeUrl;
//    @Resource
//    private UserTransactionRecdMapper userTransactionRecdMapper;
//
//    @Autowired
//    public WechatStrategy(Unique unique, Rlog rlog, RestTemplate restTemplate) {
//        this.rlog = rlog;
